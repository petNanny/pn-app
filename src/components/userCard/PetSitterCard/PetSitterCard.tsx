          ...
          <Flex gap="4">
            ...
            <Box>
              <Flex flexDirection="column" alignItems="flex-start">
                ...
                <Text opacity="0.5">{prop.distance}km - {prop.suburb} </Text>
                <div>
                  {Array(5).fill('').map((_, i) => (
                                            <StarIcon
                                                key={i}
                                                color={i < prop.rating ? 'yellow.500' : 'gray.300'}
                                            />
                                        ))}
                  </div>
              </Flex>
                    ...
                    <Box>
                        <Text opacity="0.8">{prop.price} AUD <br></br>/ night </Text>
                    </Box>
                </Flex>
            </CardHeader>
            <CardBody>
                <Text className="Card-introduction">
                    {prop.introduction}
                </Text>
            </CardBody>
            <CardFooter>
                <Text width="100%" textAlign="right" color="blue.500">Read more</Text>
